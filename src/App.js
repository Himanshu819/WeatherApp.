...
const Api_key = "d2e31b0ee0563eb02dd3f1b8758a1f95";
...
const App = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ... h-screen grid place-items-center">
